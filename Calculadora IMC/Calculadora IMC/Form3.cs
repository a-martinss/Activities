...
namespace Calculadora_IMC
{
    public partial class Form3 : Form
    {
        ...
        {
            // Forma Geométrica: Circulo, Triangulo ou Quadrilátero.
        }
        ...
        private void btn_Calcular_Click(object sender, EventArgs e)
        {
            if (rb_Circulo.Checked)
            {
                ...
                {
                    MessageBox.Show("Por favor, insira um valor válido para o diâmetro do círculo.");
                }
            }
            ...
            else if (rb_Triângulo.Checked)
            {
                ...
                {
                    MessageBox.Show("Por favor, insira valores válidos para os lados do triângulo.");
                }
            }
            ...
            else if (rb_Quadrilátero.Checked)
            {
                ...
                {
                    MessageBox.Show("Por favor, insira valores válidos para os lados do quadrilátero.");
                }
            }
